        ...
        <header className="hp-glass border-b border-brass/20 px-4 py-3.5 sm:px-6 sm:py-4">
            <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                    <h1 className="truncate font-display text-lg font-bold leading-tight tracking-tight text-parchment sm:text-xl">
                        History Pedia
                    </h1>
                    <p className="truncate text-xs text-parchment/60 sm:text-sm">
                        Tanya apa saja tentang sejarah
                    </p>
                </div>
            </div>
        </header>
